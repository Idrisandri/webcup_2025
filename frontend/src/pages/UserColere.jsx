      ...
      <div className="p-4 text-center space-y-6 mt-6">
        ...
        <div className="fixed bottom-6 right-6 z-50">
          ...
          <button
            ...
            className={`
              ...
              hover:shadow-red-300/50 hover:shadow-xl
        ...
        <div className="space-y-6">
          ...
          {publications.length > 0 ? (
            ...
            <p className="text-red-700/80 text-center italic py-6 bg-white/50 rounded-xl border border-dashed border-red-200">
