...
export default function UserJoie() {
  ...
  useEffect(() => {
    // Créer un intervalle pour le pulse d'animation
 ...
 const handleClick = () => {
        ...
        <div className="relative flex items-center justify-center">
          {!isHovered ? (
            ...
            <div className="flex items-center text-white font-medium">
              ...
              <span className="opacity-0 group-hover:opacity-100 transition-opacity duration-300">Ouvrir le Chat</span>
            </div>
          )}
        </div>
      </button>
  ...
  {/* Bouton Ajouter - Version futuriste joyeuse */}
  <button className={`
