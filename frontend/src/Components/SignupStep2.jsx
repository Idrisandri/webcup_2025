...
export default function SignupStep2() {
  ...
  const emotions = [
    { value: "joie", label: "Joie", animation: { x: -100, opacity: 0 } },
    { value: "colere", label: "Colère", animation: { y: -100, opacity: 0 } },
    { value: "regret", label: "Regret", animation: { x: 100, opacity: 0 } },
    {
      value: "tristesse",
      label: "Tristesse",
      animation: { y: 100, opacity: 0 },
    },
    { value: "peur", label: "Peur", animation: { scale: 0, opacity: 0 } },
  ];
