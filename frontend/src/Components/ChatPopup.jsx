    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed bottom-6 right-6 z-50 w-96 bg-white rounded-lg shadow-xl border border-gray-200 flex flex-col"
          style={{ height: "500px" }}
        >
          ...
          <div className="p-3 border-t border-gray-200">
            <div className="flex space-x-2">
              ...
              <button
                onClick={handleSend}
                className={`px-4 py-2 bg-neutral-500 text-white rounded-lg hover:bg-neutral-600 transition ${
